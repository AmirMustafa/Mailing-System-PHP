			...
			<div id="headbar">
					...
					<div id="body">
						...
						<div id="right_container">
							<br><br><center><h2>Footer</h2></center>
							<div id="textarea_div">
								<form action="#">
									<textarea id="textarea" rows="15" cols="120" placeholder="Enter your footer code here to update .."></textarea><br><br><br>
									<button type="submit" style="float:right; margin-right: 10%" class="btn btn-default">Update Footer</button>
								</form>
							</div>
						</div>
					</div>
