			...
			<div id="headbar">
					...
					<div id="body">
						...
						<div id="right_container">
							<br><br><center><h2>News</h2></center>
							<div id="textarea_div">
								<textarea id="textarea" rows="15" cols="120" placeholder="Enter your news article here to update .."></textarea><br><br><br>
								
								<form action="#">
									<button type="submit" style="float:right; margin-right: 10%" class="btn btn-default">Update News</button>
								
								<label id="label" class="btn btn-default btn-file">
				    			Upload Image <input type="file" style="display: none; name="filetoUpload" id="filetoUpload"">
								</label>
